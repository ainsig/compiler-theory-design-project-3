...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_elsif_statements = 62,          /* elsif_statements  */
  YYSYMBOL_elsif_statement = 63,           /* elsif_statement  */
...
{
       0,    68,    68,    71,    72,    75,    76,    77,    80,    80,
      81,    84,    85,    88,    89,    92,    95,    96,    99,   104,
     111,   114,   115,   118,   121,   122,   125,   126,   127,   128,
     132,   133,   136,   139,   140,   143,   146,   147,   148,   151,
     152,   153,   154,   158,   159,   162,   163,   164,   168,   169,
...
static const char *const yytname[] =
{
  ...
  "elsif_statements", "elsif_statement", "cases", "case", "condition",
...
{
      13,   -32,     8,    15,    34,   -75,    57,   -75,    21,    37,
      34,    68,    41,    70,    23,   -75,    85,    26,    64,   -75,
      -5,    -5,    57,   -75,   -75,    92,   -75,    99,    84,    90,
     -75,   -75,   -75,   -75,    87,    87,    73,    73,    87,   115,
      97,   128,    10,   -75,   -75,   -75,    98,   -75,    -5,    45,
     -75,    87,    10,   124,     4,    73,    73,    56,   -75,    89,
      78,     9,   -75,   -75,    87,    87,    87,    87,   -75,   117,
     100,    14,   -75,    94,    76,    50,    73,    73,    87,    87,
      26,   -75,    10,   -75,   -75,   124,   101,   -75,   -75,   103,
     -75,    94,   -75,    94,    -3,   128,   110,    87,   102,   142,
     132,   -75,    87,    73,   129,   110,    66,   128,   -75,   134,
      45,   128,    91,    26,   -75,   -75,    87,    45,   108,    26,
     116,   128,   111,   131,   -75,   -75,   -75,   -75
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,     7,     5,     0,     6,     0,     0,    55,
      50,    51,    52,    53,     0,     0,     0,     0,     0,     0,
       0,    26,    44,    47,     2,    20,     0,    19,     0,     0,
      25,     0,     0,    56,     0,     0,     0,     0,    38,     0,
       0,     0,    23,    24,     0,     0,     0,     0,     3,     0,
       0,     0,    34,    36,     0,     0,     0,     0,     0,     0,
       0,    49,    43,    45,    46,    48,     0,    13,    54,     0,
      42,    40,    37,    41,     0,    39,    31,     0,     0,     0,
       0,    33,     0,     0,     0,    31,     0,    22,    14,     0,
       0,    27,     0,     0,    30,    15,     0,     0,     0,     0,
       0,    21,     0,     0,    32,    29,    35,    28
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
     -75,   -75,   -75,   -12,   -75,   -75,   144,   -75,   -75,   -75,
     133,   -75,   -75,   -74,   -45,    51,   -75,   -75,   -75,   -30,
      81,   -35,    49,    62
};
...
{
       0,     3,     4,    27,     9,    10,    11,    98,    13,    14,
      15,   106,    18,    39,    40,   104,   105,    89,   101,    57,
      58,    41,    42,    43
};
...
{
      54,    59,    59,    61,    70,    64,    96,    60,    45,    46,
       5,     6,    64,    23,     1,     7,    71,    64,    24,    65,
      59,    75,    64,    66,    67,    73,    74,    28,    72,    29,
      30,    31,    32,    33,    26,     2,    69,     8,    34,   120,
     102,    59,    59,    94,    95,   124,    91,    93,    29,    30,
      31,    32,    33,    17,    81,    35,    36,    34,    64,    88,
      12,    79,   107,    37,    16,   118,    76,   111,    59,    22,
      38,   -11,   122,   112,    35,    36,    29,    30,    31,    32,
      33,   121,    37,    52,    20,    34,    76,    77,    76,    38,
      29,    30,    31,    32,    33,    81,    53,    64,    21,    34,
      79,    76,    78,    23,    76,    55,    44,    77,    24,    77,
      25,   115,   116,    82,    52,    52,    52,    56,    48,    80,
      99,    90,    77,    49,    26,    77,    50,    83,    84,    85,
     100,    38,   119,   -47,    51,    62,    64,   -47,   -47,    63,
      68,    86,    87,   103,   108,    97,   109,   110,   113,   117,
     123,   125,   127,   126,    19,    47,   114,    92
};

static const yytype_int8 yycheck[] =
{
      35,    36,    37,    38,    49,     8,    80,    37,    20,    21,
      42,     3,     8,    18,     1,     0,    51,     8,    23,     9,
      55,    56,     8,    13,    14,    55,    56,     1,    24,     3,
       4,     5,     6,     7,    39,    22,    48,     3,    12,   113,
      43,    76,    77,    78,    79,   119,    76,    77,     3,     4,
       5,     6,     7,    16,    45,    29,    30,    12,     8,    45,
       3,    11,    97,    37,    43,   110,    10,   102,   103,    46,
      44,     3,   117,   103,    29,    30,     3,     4,     5,     6,
       7,   116,    37,    34,    43,    12,    10,    31,    10,    44,
       3,     4,     5,     6,     7,    45,    34,     8,    28,    12,
      11,    10,    46,    18,    10,    32,    42,    31,    23,    31,
      25,    45,    46,    64,    65,    66,    67,    44,    26,    41,
      17,    45,    31,    24,    39,    31,    42,    65,    66,    67,
      27,    44,    41,     9,    44,    20,     8,    13,    14,    42,
      42,    24,    42,    33,    42,    44,     4,    15,    19,    15,
      42,    35,    21,    42,    10,    22,   105,    76
};
...
static const yytype_int8 yystos[] =
{
      ...
      43,    28,    46,    18,    23,    25,    39,    50,     1,     3,
       4,     5,     6,     7,    12,    29,    30,    37,    44,    60,
      61,    68,    69,    70,    42,    50,    50,    57,    26,    24,
      42,    44,    69,    70,    68,    32,    44,    66,    67,    68,
      66,    68,    20,    42,     8,     9,    13,    14,    42,    50,
      61,    68,    24,    66,    66,    68,    10,    31,    46,    11,
      41,    45,    69,    70,    70,    70,    24,    42,    45,    64,
      45,    66,    67,    66,    68,    68,    60,    44,    54,    17,
      27,    65,    43,    33,    62,    63,    58,    68,    42,     4,
      15,    68,    66,    19,    62,    45,    46,    15,    61,    41,
      60,    68,    61,    42,    60,    35,    42,    21
};
...
#line 1586 "parser.tab.c"
  ...
  case 29: /* statement: IF condition THEN statement_ elsif_statements ELSE statement_ ENDIF  */
#line 129 "parser.y"
                {(yyval.value) = !isnan((yyvsp[-4].value)) ? (yyvsp[-4].value) : (yyvsp[-1].value);}
#line 1592 "parser.tab.c"
    break;

  case 30: /* elsif_statements: elsif_statement elsif_statements  */
#line 132 "parser.y"
                                         { (yyval.value) = (yyvsp[-1].value) ? (yyvsp[-1].value) : (yyvsp[0].value); }
#line 1598 "parser.tab.c"
    break;

  case 31: /* elsif_statements: %empty  */
#line 133 "parser.y"
               { (yyval.value) = 0; }
#line 1604 "parser.tab.c"
    break;

  case 32: /* elsif_statement: ELSIF condition THEN statement_  */
#line 136 "parser.y"
...
#line 1628 "parser.tab.c"
  ...
  case 36: /* condition: NOTOP condition  */
#line 146 "parser.y"
                        { (yyval.value) = evaluateLogical(0, NOT, (yyvsp[0].value)); }
#line 1634 "parser.tab.c"
    break;

  case 37: /* condition: condition ANDOP relation  */
#line 147 "parser.y"
...
#line 1676 "parser.tab.c"
  ...
  case 46: /* term: term REMOP primary  */
#line 163 "parser.y"
                           {(yyval.value) = evaluateArithmetic((yyvsp[-2].value), (yyvsp[-1].oper), (yyvsp[0].value));}
#line 1682 "parser.tab.c"
    break;

  case 48: /* primary: term EXOP primary  */
#line 168 "parser.y"
                          {(yyval.value) = evaluateArithmetic((yyvsp[-2].value), (yyvsp[-1].oper), (yyvsp[0].value));}
...
#line 1700 "parser.tab.c"
  ...
  case 51: /* primary: CHAR_LITERAL  */
#line 171 "parser.y"
                     { (yyval.value) = (yyvsp[0].value); }
#line 1706 "parser.tab.c"
    break;

  case 52: /* primary: REAL_LITERAL  */
#line 172 "parser.y"
                     { (yyval.value) = (yyvsp[0].value); }
#line 1712 "parser.tab.c"
    break;

  case 53: /* primary: HEX_LITERAL  */
#line 173 "parser.y"
